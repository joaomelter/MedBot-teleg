...
void connectWiFi(); // Conecta ao wifi usando credenciais proprias
void initServer(); // Configura o servidor web com todas as rotas necessarias
void initRTC(); // inicializa o relogio de tempo real
