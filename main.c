...
#include "esp_http_client.h" // Cliente HTTP para fazer as requisições, eiar os dados para o server python
...
#include <time.h> // Bibliioteca padrão da linguagem C para manipular o c   